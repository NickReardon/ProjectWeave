...
# Automated Verification Log (archived)
...
Entries below name the source commit each run covered. They are preserved
because they describe real gate runs; for verification of any commit after
`ef1db32`, read `git log`.
