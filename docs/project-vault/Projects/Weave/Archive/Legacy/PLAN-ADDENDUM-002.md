...
Accepted product-direction clarification. This addendum and [the v1 product brief](../../Documents/Specifications/product-brief.md) take precedence over earlier portfolio-first or ceremony-heavy interpretations in `PLAN.md` and feature designs.
...
Detailed behavior and acceptance criteria are in [Streamlined long-project workflow](../../Documents/Specifications/streamlined-long-project-workflow.md).
